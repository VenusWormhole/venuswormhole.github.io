...
require(['HashChange','Keywords','EVEIGB'],function(hashchange,keywords,eveigb){
	    ...
	    if(VW){
    	    if(!text){ //Clear
    	        ...
    	        if(VW.DEV&&bError&&obj){
    	        	msg=[msg,"<br/>",obj.toString(),"<br/>",obj.stack].join("");
    	        	//console.error(obj);
    	        }
	...
	function Search( type, keyword )
	{
		...
		if(isNaN(id)){
			VW.$keyword[0].value = decodeURI(keyword);
		...
		VW.$results.html( [
            ...
            "<br/><span class='class",obj.basic.wormholeClassID,"'>",obj.basic.wormholeClassName,
				...
				"<br/><span style='color:hsl(",(obj.basic.security>=0)?Math.round(200*obj.basic.security*obj.basic.security):0,",100%,50%);'>&bull;&nbsp;",FormatNumber(obj.basic.security,3),
					...
					obj.basic.planetCount,"</span>&nbsp;&nbsp;|&nbsp;&nbsp;<span class='moon'>",obj.basic.moonCount,"</span></span><div id='trapped''></div><button>发布信息</button>",
			"</div></div>",
				...
				"<h3>",obj.wormholes.title,"</h3><div><table>",
					(function(){
						...
						for(var key in obj.wormholes.localStatic){
							...
							snippets.push([
								"<tr title='Static ",item[3],"mKg&nbsp;",item[4],"H'><td width=54><a class='wormhole' href='#showinfo/hole/",item[1],"'>",item[1],"</a></td><td><span class='whStatic'>*",
						...
						for(var key in obj.wormholes.classRoam){
							...
							snippets.push([
								"<tr  title='Roaming ",item[3],"mKg&nbsp;&nbsp;",item[4],"H'><td><a class='wormhole' href='#showinfo/hole/",item[1],"'>",item[1],"</a></td><td><span class='whRoam'>?",
								obj.wormholes.connect,"</span>&nbsp;<span class='class",item[2],"'>","&nbsp;",obj.classes[item[2]],"</span></td></tr>"
							].join(""));
						}
						return snippets.join("");
				...
				for(var key in obj.sites){
					...
					for(var key2 in obj.sites[key]){
						...
						"<tr><td>",
							...
							["<a class='",icon,"' href='#showinfo/site/"+key2,"'>",obj.sites[key][key2],"</a>"].join(''):
